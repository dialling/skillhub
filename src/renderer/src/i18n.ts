...
const DICT: Dict = {
  ...
  'bulk.explain': ['有 {n} 个技能还没安装。勾选要把它们装到哪些智能体 —— 每个智能体各写一份，同一个目录被多个智能体共用时只写一次。', '{n} skills are not installed yet. Tick the agents to install them into — one copy per agent, and a directory shared by several agents is written once.'],
  'bulk.filterAgents': ['筛选智能体…', 'Filter agents…'],
  'bulk.pickEnabled': ['已启用的', 'Enabled'],
  'bulk.pickAll': ['全选', 'All'],
