...
export const THEMES: Record<ThemeId, Theme> = {
  ...
  obsidian: {
    ...
    vars: {
      ...
      ...accentVars({
        // Restored to the palette's original brightness. The contrast problem
        // these had is solved by `onAccent` below instead of by darkening the
        // colour — the accent keeps its character and the button text stays
